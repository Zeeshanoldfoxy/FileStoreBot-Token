...
APP_ID = int(os.environ.get("APP_ID", "20292368"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "315efec39933d7b3cbe59f5167e053f0")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "1002206555727"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6037247658").split()):
        ADMINS.append(int(x))
except ValueError:
...
ADMINS.append(6037247658)

LOG_FILE_NAME = "filrstore.txt"
